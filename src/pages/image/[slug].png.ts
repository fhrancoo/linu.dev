...
export async function get(context: APIContext) {
	...
	const markup = html`<div tw='bg-[#21232D] flex flex-col w-full h-full'>
    <div tw='flex flex-col w-full h-4/5 p-10 justify-center'>
      ...
      <div
        ...
        style="background-clip: text; -webkit-background-clip: text; background: linear-gradient(to right, rgb(233, 213, 255), rgb(192, 132, 252), rgb(107, 33, 168));"
      >
        ${title}
      </div>
    </div>

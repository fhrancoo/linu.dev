...
🔅 Una vez creadas las variables, utilizamos __JSON.parse __ para tomar los elementos de la lista.
...
🔅 Creamos una función, utilizando __innerHTML __, __map __, y __join __ para renderizar la lista como HTML en el DOM.
...
🔅 Creamos una función para que el botón para borrar las listas aparezca o desaparezca dependiendo de si hay contenido o no, utilizando __lenght __.
...
4. Con el __spread operator __, asignamos a las tareas el mismo array de tareas pero sumando una tarea más. taskId + 1.
...
🔅 Creamos una función que borra las tareas utilizando __filter __.

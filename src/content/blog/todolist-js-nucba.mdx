...
**
Esta semana comenzamos a aplicar lo básico de **Javascript** en el bootcamp de NUCBA. Estamos
haciendo un ToDoList con HTML + CSS + JS.
**

![Ejemplo](https://i.imgur.com/lba4Wfq.png)

**
Nucba nos brindó un ejemplo, y me gustaría escribir el proceso que seguimos. ¡De paso, me queda a
mi como recordatorio y me sirve para aprender y procesar lo aprendido!
**
...
**
Para recordar algunas cosas de este **todo**. "**tasks**" es un array con las tareas que
agregamos.
**
